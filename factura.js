async function generarFacturaPDF(pedido) {
    try {
        ...
        // Logo 12×12mm + texto SHOP
        doc.addImage(githubLogoB64, 'PNG', 20, 15, 12, 12);
